...
class SSHConnection(object):
    ...
    def __init__(self, server, login=None, port=None, configfile=None,
        ...
        - `portforward_local`: the "port:host:port" string for the -L switch
        ...
        self.portforward_local = portforward_local
...
class SSHResult(object):
    ...
    def __repr__(self):
        ...
        ret.append('stdout: %s' % str(self.stdout))
        ret.append('stderr: %s' % str(self.stderr))
